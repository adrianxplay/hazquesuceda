	...
	class Alpha_Patcher extends Alpha_Base {
		...
		public function check_transients() {
			...
			if ( ! empty( $legacy_transient ) ) {
				if ( isset( $legacy_transient['theme_version'] ) && ALPHA_VERSION == $legacy_transient['theme_version'] && defined( 'ALPHA_CORE_VERSION' ) && isset( $legacy_transient['func_version'] ) && ALPHA_CORE_VERSION == $legacy_transient['func_version'] ) {
