...
class Alpha_Assets extends Alpha_Base {
	...
	public function register_scripts() {
		...
		if ( alpha_get_option( 'legacy_icons' ) ) {
			wp_register_style( 'alpha-icons', ALPHA_ASSETS . '/vendor/icons/legacy/css/icons.min.css', array(), ALPHA_VERSION );
		} else {
			wp_register_style( 'alpha-icons', ALPHA_ASSETS . '/vendor/icons/' . alpha_get_option( 'icon_weight' ) . '/css/icons.min.css', array(), ALPHA_VERSION );
		}
	...
	public function enqueue_scripts() {
		...
		$localize_vars['popup_last_time'] = alpha_get_option( 'popup_last_time' );
