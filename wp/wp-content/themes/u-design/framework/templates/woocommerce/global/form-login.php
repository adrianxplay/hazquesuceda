...
<form class="woocommerce-form woocommerce-form-login login" method="post" <?php echo ! $hidden ? '' : 'style="display:none;"'; ?>>
	...
	<div class="form-row form-footer">
		<div class="custom-input">
			...
			<label for="rememberme"><?php esc_html_e( 'Remember me', 'alpha' ); ?></label>
		</div>
	...
	<button type="submit" class="woocommerce-button button woocommerce-form-login__submit" name="login" value="<?php esc_attr_e( 'Login', 'alpha' ); ?>"><?php esc_html_e( 'Login', 'alpha' ); ?></button>
