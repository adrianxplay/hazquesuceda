		...
		<form class="yith-wcwl-popup-form" method="post" action="<?php echo esc_url( add_query_arg( 'add_to_wishlist', $product_id, $base_url ) ); ?>">
			<div class="yith-wcwl-popup-content">
				...
				<p class="popup-description">
					<a href="#" class="show-tab active" data-tab="choose"><?php esc_html_e( 'Choose a wishlist', 'alpha' ); ?></a>
					<?php esc_html_e( 'or', 'alpha' ); ?>
					<a href="#" class="show-tab" data-tab="create"><?php esc_html_e( 'Create a new list', 'alpha' ); ?></a>
				</p>
				...
				<div class="tab create">
					<p class="form-row form-row-wide">
						<input name="wishlist_name" class="wishlist-name input-text" type="text" placeholder="<?php echo esc_attr( apply_filters( 'yith_wcwl_new_list_title_text', __( 'Enter wishlist name', 'alpha' ) ) ); ?>"/>
					</p>
