						...
						<div class="item-details">
							<div class="item-details-wrapper">
									...
									<table class="item-details-table">
										...
										<?php if ( $show_price || $show_price_variations ) : ?>
											<tr class="product-price">
												<td class="label">
													<?php esc_html_e( 'Unit Price:', 'alpha' ); ?>
												</td>
												<td class="value">
													<?php
													if ( $show_price ) {
								...
								<div class="product-add-to-cart">
									...
									<!-- Quickview Button -->
									<?php echo '<button class="btn btn-quickview btn-outline btn-default btn-rounded btn-dark btn-md" data-mfp-src="' . alpha_get_product_featured_image_src( $product ) . '" data-product="' . $product->get_id() . '" title="' . esc_html__( 'Quick View', 'alpha' ) . '">' . esc_html__( 'Quick View', 'alpha' ) . '</button>'; ?>
