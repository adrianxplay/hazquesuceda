			...
			if ( $product && $product->exists() ) :
				...
				<li id="yith-wcwl-row-<?php echo esc_attr( $item->get_product_id() ); ?>" data-row-id="<?php echo esc_attr( $item->get_product_id() ); ?>">
					...
					<div class="additional-info-wrapper">
						...
						<!-- Quickview Button -->
						<?php echo '<button class="btn btn-quickview btn-outline btn-dark btn-rounded btn-md" data-mfp-src="' . alpha_get_product_featured_image_src( $product ) . '" data-product="' . $product->get_id() . '" title="' . esc_html__( 'Quick View', 'alpha' ) . '">' . esc_html__( 'Quick View', 'alpha' ) . '</button>'; ?>
							...
							<div class="product-add-to-cart">
								...
								woocommerce_template_loop_add_to_cart(
									array(
										...
										'class'    => 'btn btn-rounded btn-dark btn-md',
									)
								);
								?>
							</div>
