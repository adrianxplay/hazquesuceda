	...
	if ( $wishlist && $wishlist->has_items() ) :
					...
					<?php if ( $show_last_column ) : ?>
						<td class="product-add-to-cart">
							<div class="yith-product-actions">
								...
								<!-- Quickview Button -->
								<?php echo '<button class="btn btn-quickview btn-outline btn-default btn-dark btn-sm" data-mfp-src="' . alpha_get_product_featured_image_src( $product ) . '" data-product="' . $product->get_id() . '" title="' . esc_html__( 'Quick View', 'alpha' ) . '">' . esc_html__( 'Quick View', 'alpha' ) . '</button>'; ?>
								...
								<?php if ( $show_add_to_cart && isset( $stock_status ) && $stock_status != 'out-of-stock' ) : ?>
									...
									woocommerce_template_loop_add_to_cart(
										array(
											...
											'class'    => 'btn btn-dark btn-dark btn-sm',
										)
									);
									?>
								<?php endif ?>
								...
								if ( $repeat_remove_button ) :
									 ...
									 */
									?>
									<a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist', $item->get_product_id() ) ); ?>" class="btn btn-sm remove_from_wishlist button" title="<?php echo esc_attr( apply_filters( 'yith_wcwl_remove_product_wishlist_message_title', __( 'Remove this product', 'alpha' ) ) ); ?>"><?php esc_html_e( 'Remove', 'alpha' ); ?></a>
								<?php endif; ?>
		...
		<tr>
			<td colspan="<?php echo esc_attr( $column_count ); ?>">
				<a class="button btn btn-rounded btn-dark" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>">
