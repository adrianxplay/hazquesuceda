...
$is_builder_rendering = alpha_wc_get_loop_prop( 'is_shop_builder_rendering' );
?>
...
<div class="sticky-toolbox sticky-content fix-top toolbox toolbox-top">
	<div class="toolbox-left">
		...
		if ( $toggle_class ) :
			...
			?>
			<a href="#" class="toolbox-item toolbox-toggle <?php echo esc_attr( $toggle_class ); ?> btn btn-sm btn-outline btn-primary btn-icon-left"><i class="fas fa-list"></i><span class="d-none d-sm-block"><?php esc_html_e( 'Filters', 'alpha' ); ?></span></a>
		<?php endif; ?>
<?php endif; ?>
<?php if ( ! alpha_wc_get_loop_prop( 'is_shop_builder_products' ) ) : ?>
