...
if ( ! empty( $product_tabs ) ) :
	...
	if ( 'accordion' == $product_tabs_type ) {
		...
		// $wrapper_class .= ' wc-tabs-wrapper wc-tabs tab tab-nav-separated';
		$wrapper_class .= ' wc-tabs-wrapper wc-tabs tab';
	} else {
	...
	<div class="<?php echo esc_attr( apply_filters( 'alpha_single_product_data_tab_class', $wrapper_class ) ); ?>">
