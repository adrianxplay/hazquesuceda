...
(function ($, window, document, undefined) {
    ...
    $.fn.lazyload = function (options) {
        ...
        function update() {
            ...
            elements.each(function (index) {
                ...
                if ($this.closest('.splide').length && !$.abovethetop(this, settings) && !$.belowthefold(this, settings)) {
                    $this.trigger("appear");
                    counter = 0;
                ...
                if (!this.loaded) {
                    ...
                    function loadImage(e) {
                        ...
                        var original = $self.attr(o_img_attr),
                            ...
                            sizes = $self.attr("data-" + settings.data_sizes);
                        ...
                        if ($self.is("img")) {
                            ...
                            if (!$self.hasClass('no-transition') || e.type == 'error') {

                                e.type == 'error' || $self.hide().addClass('no-transition');
    ...
    $.abovethetop = function (element, settings) {
        ...
        return fold >= $(element).offset().top + settings.threshold + element.offsetHeight;
    };
