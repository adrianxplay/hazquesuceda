<?php
/**
 * Alpha Product Category card Functions
 *
 * Functions used to display card type.
 *
 * @author     Andon
...
// Category Thumbnail
add_action( 'woocommerce_before_subcategory_title', 'alpha_pc_card_before_subcategory_thumbnail', 5 );
add_action( 'woocommerce_before_subcategory_title', 'alpha_pc_card_after_subcategory_thumbnail', 15 );
add_action( 'woocommerce_before_subcategory_title', 'alpha_pc_card_subcategory_thumbnail' );

// Category Content
add_action( 'woocommerce_after_subcategory_title', 'alpha_pc_card_after_subcategory_title' );
add_action( 'woocommerce_shop_loop_subcategory_title', 'alpha_pc_card_template_loop_category_title' );

/**
 * pc_card_before_subcategory_thumbnail
 *
 ...
 * @since 4.1
 */
if ( ! function_exists( 'alpha_pc_card_before_subcategory_thumbnail' ) ) {
	function alpha_pc_card_before_subcategory_thumbnail( $category ) {
		if ( 'card' != alpha_wc_get_loop_prop( 'category_type' ) ) {
			return;
		}
 ...
 * @since 4.1
 */
if ( ! function_exists( 'alpha_pc_card_subcategory_thumbnail' ) ) {
	function alpha_pc_card_subcategory_thumbnail( $category ) {
		if ( 'card' != alpha_wc_get_loop_prop( 'category_type' ) ) {
			return;
		}
...
/**
 * pc_card_after_subcategory_thumbnail
 *
 * Render html after subcategory thumbnail.
 *
 * @param string $category
 * @since 4.1
 */
if ( ! function_exists( 'alpha_pc_card_after_subcategory_thumbnail' ) ) {
	function alpha_pc_card_after_subcategory_thumbnail( $category ) {
		if ( 'card' != alpha_wc_get_loop_prop( 'category_type' ) ) {
			return;
		}
 ...
 * @since 4.1
 */
if ( ! function_exists( 'alpha_pc_card_template_loop_category_title' ) ) {
	function alpha_pc_card_template_loop_category_title( $category ) {
		if ( 'card' != alpha_wc_get_loop_prop( 'category_type' ) ) {
			return;
		}
...
/**
 * pc_card_after_subcategory_title
 *
 * Render html after subcategory title.
 *
 * @since 4.1
 */
if ( ! function_exists( 'alpha_pc_card_after_subcategory_title' ) ) {
	function alpha_pc_card_after_subcategory_title() {
		if ( 'card' == alpha_wc_get_loop_prop( 'category_type' ) ) {
			echo '</div>';
			echo '</a>';
		}
