...
<div class="alpha-setup-next-steps">
	<div class="alpha-setup-next-steps-first">
		...
		<ul class="external-links" style="margin-bottom:40px;">
			...
			<li class="woocommerce documentation"><a href="https://docs.woocommerce.com/document/woocommerce-101-video-series/" target="_blank"><i class="<?php echo THEME_ICON_PREFIX; ?>-icon-cart2"></i><?php esc_html_e( 'Learning WooCommerce', 'alpha' ); ?></a></li>
