...
<div class="learn-press-tabs tab tab-nav-underline tab-nav-left">
	<?php
	foreach ( $sections as $section_key => $section_data ) {
		...
		<input type="radio" name="<?php echo esc_attr( $unique_group ); ?>>" class="learn-press-tabs__checker" <?php echo alpha_escaped( $checked ); ?> id="<?php echo esc_attr( $unique_group . '__' . $section_key ); ?>"/>
	<?php } ?>

	<ul class="nav nav-tabs" data-tabs="<?php echo count( $visible_tabs ); ?>">
		<?php
		foreach ( $sections as $section_key => $section_data ) {
			...
			$classes = array( 'learn-press-tabs__tab', 'nav-item', esc_attr( $section_key ) );
			...
			<li class="<?php echo implode( ' ', $classes ); ?>">
				<label><a href="<?php echo esc_url( $section_link ); ?>" class="nav-link<?php echo esc_attr( $active_tab == $section_key ? ' active' : '' ); ?>"><?php echo esc_html( $section_data['title'] ); ?></a></label>
			</li>
