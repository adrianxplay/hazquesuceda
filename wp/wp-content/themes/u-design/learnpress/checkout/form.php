...
if ( ! is_user_logged_in() ) {
	...
	<div class="learn-press-message error">
		<?php _e( 'Please login to enroll the course!', 'alpha' ); ?>
	</div>
	<?php
}
?>

	<form method="post" id="learn-press-checkout-form" name="learn-press-checkout-form" class="lp-checkout-form row" tabindex="0" action="<?php echo esc_url( learn_press_get_checkout_url() ); ?>" enctype="multipart/form-data">
		<?php
