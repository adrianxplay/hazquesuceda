...
define('ESG_TP_TOOLS', '6.7.5');
define('ESG_REVISION', '3.1.2.2');
...
if (is_admin()) {
	...
	add_action('plugins_loaded', array('Essential_Grid_Admin', 'do_update_checks'), 5);
	add_action('plugins_loaded', array('Essential_Grid_Admin', 'get_instance'), 10);
	add_action('plugins_loaded', array('Essential_Grid_Admin', 'visual_composer_include'), 15);
}
