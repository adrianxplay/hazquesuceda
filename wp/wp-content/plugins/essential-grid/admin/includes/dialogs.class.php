...
class Essential_Grid_Dialogs {
	...
	public static function error_import_grid(){
		?>
		<div id="error_imported_grid" class="essential-dialog-wrap essential-dialog-padding esg-display-none" title="<?php esc_attr_e('Grid Import Error', ESG_TEXTDOMAIN); ?>">
		...
		<div id="edit-custom-element-quick-dialog-wrap" class="essential-dialog-wrap essential-dialog-padding esg-display-none" title="<?php esc_attr_e('Custom Element Settings', ESG_TEXTDOMAIN); ?>">			
			...
			<div class="esg-item-skin-elements">
				...
				<div class="esg-csi-itemtype-image">
					...
					--><div id="custom-image-wrapper" class="esg-custom-image-wrapper"><img id="esg-custom-image-img" class="esg-custom-image-img-1" src="" alt=""></div>
				</div>
			...
			<form id="edit-custom-element-form">
				<div id="esg-item-skin-elements-media" class="eg-options-tab esg-display-block">
					...
					<div class="esg-item-skin-elements" id="esg-item-skin-elements-media-image">
						...
						<div id="custom-image-wrapper" class="esg-custom-image-wrapper"><img id="esg-custom-image-img" class="esg-custom-image-img" src="" alt=""></div>
					</div>			
							...
							foreach($element as $handle => $itm){
								...
								switch($itm['type']) {
									...
									case 'image';
										...
										echo '<div class="esg-custom-image-wrapper"><img id="eg-' . $handle . '-cm-img" src="" class="esg-custom-image-img" alt=""></div>';
								...
								<?php
									switch($cmeta['type']){
										...
										case 'image':
											...
											<div class="esg-custom-image-wrapper"><img id="eg-<?php echo $cmeta['handle'].'-cm'; ?>-img" src="<?php echo $var_src; ?>" <?php echo ($var_src == '') ? 'class="esg-custom-image-img"' : ''; ?> alt=""></div>
											<?php
										break;
									}
									?>
