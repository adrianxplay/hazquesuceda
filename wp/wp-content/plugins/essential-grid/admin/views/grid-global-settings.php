		...
		<div id="esg-global-settings" class="esg-settings-container active-esc">
			...
			<div> <!-- Content Settings-->
				...
				<div class="eg-cs-tbc">
					...
					<div class="div5"></div>
					<img id="global_default_img-img" class="image-holder-wrap-div esg-display-<?php echo $display_global_img; ?>" src="<?php echo $global_default_src; ?>" alt="">
...
<script type="text/javascript">	
	...
	ESG.E.SearchSettings = <?php echo json_encode($settings); ?>;
	ESG.E.CustomMetas = <?php echo json_encode($custom_metas); ?>;
	ESG.E.LinkMetas = <?php echo json_encode($link_metas); ?>;
