...
global $esg_dev_mode;
if($esg_dev_mode) {
	wp_enqueue_script('esg-item-editor-script', plugins_url('../../assets/js/modules/dev/grid-editor.js', __FILE__ ), array('jquery'), ESG_REVISION );
} else {
	wp_enqueue_script('esg-item-editor-script', plugins_url('../../assets/js/modules/grid-editor.min.js', __FILE__ ), array('jquery'), ESG_REVISION );
}
...
$fonts_full = apply_filters('essgrid_item_skin_editor_fonts_full', array());
							...
							<div id="eg-lc-content-animation" class="esg-lc-settings-container ">
								...
								<div id="eg-cover-animation-top">
									...
									--><select name="cover-animation-top-type" class="esg-w-60" title="<?php esc_attr_e('Show or Hide on hover. In = Show on Hover, Out = Hide on hover', ESG_TEXTDOMAIN); ?>">
										<option value="" <?php selected($base->getVar($skin, array('params', 'cover-animation-top-type')), ''); ?>><?php esc_html_e('in', ESG_TEXTDOMAIN); ?></option>
										<option value="out" <?php selected($base->getVar($skin, array('params', 'cover-animation-top-type')), 'out'); ?>><?php esc_html_e('out', ESG_TEXTDOMAIN); ?></option>
									</select><div class="space5"></div><!--
								...
								<div id="eg-cover-animation-center">
									...
									--><select name="cover-animation-center-type" class="eg-tooltip-wrap esg-w-60" title="<?php esc_attr_e('Show or Hide on hover. In = Show on Hover, Out = Hide on hover', ESG_TEXTDOMAIN); ?>">
										<option value="" <?php selected($base->getVar($skin, array('params', 'cover-animation-center-type')), ''); ?>><?php esc_html_e('in', ESG_TEXTDOMAIN); ?></option>
										<option value="out" <?php selected($base->getVar($skin, array('params', 'cover-animation-center-type')), 'out'); ?>><?php esc_html_e('out', ESG_TEXTDOMAIN); ?></option>
									</select><div class="space5"></div><!--
								...
								<div id="eg-cover-animation-bottom">
									...
									--><select name="cover-animation-bottom-type" class="eg-tooltip-wrap esg-w-60" title="<?php esc_attr_e('Show or Hide on hover. In = Show on Hover, Out = Hide on hover', ESG_TEXTDOMAIN); ?>">
										<option value="" <?php selected($base->getVar($skin, array('params', 'cover-animation-bottom-type')), ''); ?>><?php esc_html_e('in', ESG_TEXTDOMAIN); ?></option>
										<option value="out" <?php selected($base->getVar($skin, array('params', 'cover-animation-bottom-type')), 'out'); ?>><?php esc_html_e('out', ESG_TEXTDOMAIN); ?></option>
									</select><div class="space5"></div><!--
							...
							<div id="eg-lc-content-link-seo" class="esg-lc-settings-container">
									...
									<div class="add-link-to-wrapper" class="esg-display-none">
										...
										<div id="eg-link-post-meta-wrap" class="esg-display-none">
											<div class="div13"></div>
											<label><?php esc_html_e('Meta Key', ESG_TEXTDOMAIN); ?></label><input class="element-setting" type="text" name="link-meta-link" value="<?php echo $base->getVar($skin, array('params', 'link-meta-link')); ?>" readonly /><div class="space18"></div><!--
											--><div class="esg-btn esg-purple" id="button-open-link-link-meta-key"><i class="eg-icon-down-open"></i><?php esc_html_e('Choose Meta Key', ESG_TEXTDOMAIN); ?></a></div>
						...
						<form id="eg-item-element-settings-wrap">
							<div id="settings-dz-elements-wrapper" class="eg-ul-tabs">
												...
												--><select name="element-source-taxonomy">
													<?php
														...
														foreach ($taxonomies as $taxonomy_name => $taxonomy) {
															echo '<option value="'.$taxonomy_name.'">'.$taxonomy->labels->name.' ('.$taxonomy_name.')</option>';
														}
													?>
												</select>
											</div>
								...
								<div id="eg-element-hide">
									...
									<div class="esg-display-none esg-color-blue esg-warning-element-hideunder"><?php esc_html_e('This option will override "Show without..." settings', ESG_TEXTDOMAIN); ?></div>
									<div class="div13"></div>
									...
									<div class="esg-display-none esg-color-blue esg-warning-element-hideunderheight"><?php esc_html_e('This option will override "Show without..." settings', ESG_TEXTDOMAIN); ?></div>
									<div class="div13"></div>
								...
								<div id="eg-element-link">
									...
									<div id="eg-element-post-meta-wrap" class="esg-display-none">
										<label><?php esc_html_e('Meta Key', ESG_TEXTDOMAIN); ?></label><input class="element-setting" type="text" name="element-meta-link" value="" readonly /><div class="space18"></div><!--
									...
									<div class="eg-element-pinterest-wrap" id="eg-element-pinterest-wrap">
										...
										--><textarea type="text" name="element-pinterest-description" class="eg-tooltip-wrap esg-w-250" title="<?php esc_attr_e('Use placeholder &#37;title&#37;, &#37;excerpt&#37; for replacement', ESG_TEXTDOMAIN); ?>"></textarea>
										<div class="div13"></div>
									</div>
