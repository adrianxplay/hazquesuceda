...
<form id="eg-form-create-settings">
	...
	<div id="media-playbackingrid-wrap">
		<div>
			...
			<div class="eg-cs-tbc">             
				<label for="videoplaybackingrid" class="eg-tooltip-wrap" title="<?php esc_attr_e('Play Video directly in Grid', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Video Playback in Grid', ESG_TEXTDOMAIN); ?></label><!--
				--><input type="radio" name="videoplaybackingrid" value="on" <?php checked($base->getVar($grid, array('params', 'videoplaybackingrid'), 'on'), 'on'); ?>><!--
				--><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Allow Video Playback directly in Grid', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Enable', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio"  name="videoplaybackingrid" value="off" <?php checked($base->getVar($grid, array('params', 'videoplaybackingrid'), 'on'), 'off'); ?>><!--
				--><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Disable Video Playback directly in Grid', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Disable', ESG_TEXTDOMAIN); ?></span>
				...
				<div class="esg-videoplaybackingrid-wrapper esg-display-none">
					...
					--><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Allow Loop Video in Grid', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Enable', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
					--><input type="radio"  name="videoloopingrid" value="off" <?php checked($base->getVar($grid, array('params', 'videoloopingrid'), 'off'), 'off'); ?>><!--
					--><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Disable Loop Video in Grid', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Disable', ESG_TEXTDOMAIN); ?></span>
					<div><label></label><?php esc_html_e('Looped video(s) will be muted to allow autoplay.', ESG_TEXTDOMAIN); ?></div>
					
					<div class="div13"></div>
					<label for="videoplaybackonhover" class="eg-tooltip-wrap" title="<?php esc_attr_e('Video Playback directly in Grid on Hover', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Video Playback on Hover', ESG_TEXTDOMAIN); ?></label><!--
					...
					--><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Show Inline Controls', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Enable', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
					...
					--><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Hide Inline Controls', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Disable', ESG_TEXTDOMAIN); ?></span> 
	...
	<div class=" eg-blankitem-hideable">
		...
		<div class="eg-cs-tbc">         
			...
			--><?php $blank_breakpoint = $base->getVar($grid, array('params', 'blank-item-breakpoint'), 'none'); ?><select class="eg-tooltip-wrap" name="blank-item-breakpoint" title="<?php esc_attr_e('Hide Blank Items at a certain break-point', ESG_TEXTDOMAIN); ?>">
