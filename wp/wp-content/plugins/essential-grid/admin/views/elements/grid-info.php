...
<div class="flex-grid">
	...
	<div class="col">
		<div id="esg-version-information" class="esg_info_box">
			...
			<div><?php esc_html_e("Installed Version", ESG_TEXTDOMAIN); ?>: <span id="esg-vi-cv"><?php echo ESG_REVISION; ?></span></div>
			<div><?php esc_html_e("Available Version", ESG_TEXTDOMAIN); ?>: <span id="esg-vi-lv"><?php echo $latest_version; ?></span></div>
			<div class="div10"></div>
	...
	<div class="col esg-w-100p">
		<div class="esg_info_box">
			<div class="esg-purple esg_info_box_decor" ><i class="eg-icon-back-in-time"></i></div>
			<div class="view_title"><?php esc_html_e("Update History", ESG_TEXTDOMAIN); ?></div>
			<div class="esg-release-log-container">
			<?php
				$log = realpath(ESG_PLUGIN_PATH . "release_log.html");
				echo !empty($log) ? file_get_contents($log) : 'Release log not found.';
			?>
			</div>
		</div>
	</div>
