...
$related_posts = new WP_Query( Alpha_CPTS::get_instance()->related_posts( get_the_ID(), $alpha_layout['related_count'], 'member' ) );
...
if ( $related_posts && $related_posts->have_posts() ) :
	...
	<section class="related-posts">
		<h3 class="title title-simple"><?php echo alpha_get_option( 'member_related_title' ); ?></h3>
		<div>
			<?php
			$props = array(
				'posts_layout' => 'slider',
