...
if ( ! function_exists( 'alpha_elementor_banner_controls' ) ) {
	...
	function alpha_elementor_banner_controls( $self, $mode = '' ) {
			...
			$repeater->start_controls_tab(
				...
				$repeater->add_control(
					...
					array(
						...
						'selectors'   => array(
							'.elementor-element-{{ID}} {{CURRENT_ITEM}} img, .elementor-element-{{ID}} {{CURRENT_ITEM}}.divider-wrap, .elementor-element-{{ID}} {{CURRENT_ITEM}} .divider, .elementor-element-{{ID}} {{CURRENT_ITEM}}.btn, .elementor-element-{{ID}} {{CURRENT_ITEM}}.btn-bubble:before' => 'border-radius: {{SIZE}}{{UNIT}};',
						),
					)
				);
				...
				$repeater->add_responsive_control(
					...
					array(
						...
						'description' => esc_html__( 'Controls the padding of item.', 'alpha-core' ),
						'type'        => Controls_Manager::DIMENSIONS,
						'default'     => array(
							'unit' => 'px',
						),
						'conditions'  => array(
							...
							'terms'    => array(
								array(
									'name'     => 'banner_item_type',
									'operator' => '!in',
									'value'    => array( 'divider', 'hotspot', 'button' ),
								),
								array(
									'relation' => 'and',
									'terms'    => array(
		...
		$self->add_control(
			...
			array(
				'label'       => esc_html__( 'Color', 'alpha-core' ),
				'description' => esc_html__( 'Controls the content color', 'alpha-core' ),
				'type'        => Controls_Manager::COLOR,
				'selectors'   => array(
 ...
 *
 * @since 4.0
 * @since 4.1 Merged section's banner and banner widget controls
 */
		...
		if ( $widget ) {
			...
			$self->add_control(
				...
				array(
					...
					'type'        => Controls_Manager::COLOR,
					'selectors'   => array(
						'.elementor-element-{{ID}} .overlay-effect-5:before, 
						.elementor-element-{{ID}} .overlay-effect-6 figure:before, 
						.elementor-element-{{ID}} .overlay-effect-7:before' => 'background: {{VALUE}};',
					),
					'condition'   => array(
			...
			$self->add_control(
				...
				array(
					...
					'options'     => array(
						...
						'sepia(0.2)'         => esc_html__( 'Sepia', 'alpha-core' ),
					),
					'selectors'   => array(
