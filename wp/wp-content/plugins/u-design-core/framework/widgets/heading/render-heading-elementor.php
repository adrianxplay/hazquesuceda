...
if ( $title_align && $title_align_widescreen ) {
	$wrap_class .= ' ' . str_replace( '-', '-xxl-', $title_align_widescreen );
}
if ( $title_align && $title_align_laptop ) {
	$wrap_class .= ' ' . str_replace( '-', '-xlg-', $title_align_laptop );
}
