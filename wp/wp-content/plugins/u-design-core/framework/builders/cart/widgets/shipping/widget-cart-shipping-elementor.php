				...
				$this->start_controls_tab(
					...
					$this->add_control(
						...
						array(
							...
							'type'        => Controls_Manager::COLOR,
							'selectors'   => array(
								'.elementor-element-{{ID}} .form-row .input-text, .elementor-element-{{ID}} .form-row select, .elementor-element-{{ID}} .form-row span, .elementor-element-{{ID}} .form-row .select2-container--default .select2-selection--single' => 'background-color: {{VALUE}};',
							),
						)
					);
					$this->add_control(
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						...
						array(
							...
							'type'        => Controls_Manager::COLOR,
							'selectors'   => array(
								'.elementor-element-{{ID}} .form-row .input-text:focus, .elementor-element-{{ID}} .form-row select:focus' => 'background-color: {{VALUE}};',
							),
						)
					);
					$this->add_control(
